...
namespace Enyim.Caching.Memcached {
    ...
    public sealed class DefaultNodeLocator : IMemcachedNodeLocator, IDisposable {
        ...
        IMemcachedNode IMemcachedNodeLocator.Locate(string key) {
            ...
            try { return this.Locate(key); } finally { this.serverAccessLock.ExitUpgradeableReadLock(); }
        }

        IEnumerable<IMemcachedNode> IMemcachedNodeLocator.GetWorkingNodes() {
            this.serverAccessLock.EnterReadLock();

            try { return this.allServers.Except(this.deadServers.Keys).ToArray(); } finally { this.serverAccessLock.ExitReadLock(); }
        }
